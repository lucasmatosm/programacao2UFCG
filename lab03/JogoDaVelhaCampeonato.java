...
public class JogoDaVelhaCampeonato {
	...
	private static String jogada1, jogada2;
    private static int jogada=0,j,i,opcao, z;
    private static Scanner sc = new Scanner(System.in);
	public static void main(String args[]){
		System.out.println("Digite o nome dos jogadores do campeonato:");
		for(z = 0; z < 4; z++){
			jogadores[z] = sc.nextLine();
		}
		while(true){
			System.out.println("Digite o nome dos jogadores da partida:");
			jogada1 = sc.nextLine();
			jogada2 = sc.nextLine();
			for(z = 0; z < 4; z++){
				if (jogada1 == jogadores[z]){
					break;
				}
			}
